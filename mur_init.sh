...
git clone --branch develop/add_cone_change git@github.com:MURDriverless/planner_exploratory.git
git clone --branch dev/intTesting git@github.com:MURDriverless/slam.git
